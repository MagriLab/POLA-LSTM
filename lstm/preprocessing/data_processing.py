...
def create_df_nd(series, window_size, batch_size, shuffle_buffer, shuffle_window=10):
    n = series.shape[1]
    m = series.shape[0]
...
def create_df_nd_even_md(
    ...
    dataset = dataset.padded_batch(
        batch_size, padded_shapes=([None, len(idx_lst)], [None, n])
    )
    return idx_lst, dataset


def create_df_nd_random_md_idx(
