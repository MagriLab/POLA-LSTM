"""Implementation of the truncated Charney-DeVore (CDV) system based 
    on Physics-Informed Echo Satet Networks from Doan et al. """
...
def cdv_system_tensor(u):
    ...
    return tf.stack([u_dot_1, u_dot_2, u_dot_3, u_dot_4, u_dot_5, u_dot_6], 1)
