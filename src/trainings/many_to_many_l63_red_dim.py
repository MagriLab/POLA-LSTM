...
def run_lstm(args: argparse.Namespace):
    ...
    # Windowing
    train_dataset = create_df_nd_md_mtm(df_train.transpose(), args.window_size, args.batch_size, df_train.shape[0], idx_skip=0)
...
# python many_to_many_l63_red_dim.py -dp ../models/l63/500000/d2_to_full/ -cp /Users/eo821/Documents/PhD_Research/PI-LSTM/Lorenz_LSTM/src/diff_dyn_sys/lorenz63/CSV/500000/rk4_500000_norm_trans.csv