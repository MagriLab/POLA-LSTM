...
def run_lstm():
    ...
    datapath = Path("../models/lorenz/sweep_Test/")
    ...
    df_train, df_valid, df_test = df_train_valid_test_split(mydf[1:, :], train_ratio=parsed_args.train_ratio, valid_ratio=parsed_args.valid_ratio)
    time_train, time_valid, time_test = train_valid_test_split(mydf[0, :], train_ratio=parsed_args.train_ratio, valid_ratio=parsed_args.valid_ratio)
