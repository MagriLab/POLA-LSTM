...
plt.plot(lyapunov_time[:len(LEs_loaded)], LEs_loaded[:, 0], label='LSTM LEs +, final value: '+"%.2f" %LEs_loaded[-1, 0])
plt.plot(lyapunov_time[:len(LEs_loaded)], LEs_loaded[:, 1], label='LSTM LEs 0, final value: '+"%.2f" %LEs_loaded[-1, 1])
plt.plot(lyapunov_time[:len(LEs_loaded)], LEs_loaded[:, 2], label='LSTM LEs -, final value: '+"%.2f" %LEs_loaded[-1, 2])
...
plt.plot(lyapunov_time[:len(LEs_loaded)], np.ones(shape=(1, len(LEs_loaded))).T * LEs_euler[2], 'k--', label="Euler LEs")
plt.xlabel('LT')
...
plt.savefig(model_path+'lyapunox_exp_100LT.png', dpi=100, facecolor="w", bbox_inches="tight")
print('Plot saved at', model_path+'lyapunox_exp_100LT.png')